...
class DetailWorkoutSettingsViewModelFactory (private val workoutId : Int = 0, private val dataSource: AllmightDatabase, private val application: Application) : ViewModelProvider.Factory {
